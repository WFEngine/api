...
namespace WFEngine.Api.Filters
{
    ...
    /// 
    /// </summary>
    public class WFSolutionCollaboratorWriteAttribute : Attribute, IActionFilter
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            using (IUnitOfWork uow = new UnitOfWork())
            {
                ...
                if(isCollaborator.Data.CollaboratorTypeId != Core.Enums.enumCollaboratorType.OWNER && isCollaborator.Data.CollaboratorTypeId!= Core.Enums.enumCollaboratorType.WRITE)
                {
                    IActionFilterResult.UnAuthorized<int>(context, baseLocalizer);
                    return;
                }
